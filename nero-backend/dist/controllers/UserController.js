...
exports.list = exports.remove = exports.update_photo = exports.update = exports.show = exports.store = exports.index = void 0;
...
const update_photo = async (req, res) => {
    ...
    const user = await (0, ShowUserService_1.default)(userId);
    if (fs_1.default.existsSync(`${process.env.rootPath}${user.photo}`))
        fs_1.default.unlinkSync(`${process.env.rootPath}${user.photo}`);
    await user.update({

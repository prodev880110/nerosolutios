...
const authStateLegacy_1 = __importDefault(require("../helpers/authStateLegacy"));
        ...
        try {
            (async () => {
                ...
                const { state, saveState } = isLegacy
                    ? await (0, authStateLegacy_1.default)(whatsapp)
                    : await (0, authState_1.default)(whatsapp);
                wsocket = isLegacy
                    ? (0, baileys_1.makeWALegacySocket)({
                        logger: loggerBaileys,

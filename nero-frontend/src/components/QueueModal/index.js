...
const QueueModal = ({ open, onClose, queueId }) => {
  ...
  const handleSaveSchedules = async (values) => {
    toast.success("Click save to register the changes");
    setSchedules(values);
    setTab(0);
  };
  ...
  return (
    <div className={classes.root}>
      ...
      >
        ...
        >
          <Tab label="Queue Data" />
          {schedulesEnabled && <Tab label="Schedules of Service" />}
        </Tabs>
        {tab === 0 && (
          <Paper>
            <Formik
              ...
              {({ touched, errors, isSubmitting, values }) => (
                <Form>
                  <DialogContent dividers>
                    ...
                    {queueId && (<QueueOptions queueId={queueId} />)}
